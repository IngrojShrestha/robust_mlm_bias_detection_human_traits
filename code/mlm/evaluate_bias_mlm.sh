...
# mlm_association_score.py
# For details on available arguments and their usage, refer to the parse_arguments() method.
...
python3   mlm_association_score.py \
        --model roberta-large \
        ...
        --output_path ../../output/mlm_output/factor1_paired_true_cases_neo.tsv 
...
python3  mlm_association_score.py \
        ...
        --templates_path ../../data/templates.txt \
        --target_path ../../data/character_traits/positive/factor1.txt \
        --output_path ../../output/mlm_output/factor1_binary.tsv 
...
python3 ../sentence_pair_generation.py \
        --male_attr_path ../../data/attributes/males.txt \
        --female_attr_path ../../data/attributes/females.txt \
        --in_file_path ../../output/mlm_output/factor1_binary.tsv  \
        --output_path ../../output/mlm_output/factor1_paired_true_cases_binary.tsv 

# generate pairwise dataset for analyzing pairwise gender bias (M-F, M-N, F-N)
python3 ../generate_pairwise_association_scores.py \
        --binary_filepath ../../output/mlm_output/factor1_paired_true_cases_binary.tsv \
        --neo_filepath ../../output/mlm_output/factor1_paired_true_cases_neo.tsv \
        --output_dir ../../output/mlm_output/


# Example to analyze bias 
    ...
    do
        ...
        for r_model in "${!r_models[@]}"; do
            ...
            Rscript ../${r_models[$r_model]} \
                    ...
                    --input_file "../output/mlm_output/factor${factor_num}_paired_true_cases_female_neo.tsv" \
                    --output_txt_file "../output/mlm_output/bias_R2_factor${factor_num}_${selection_criteria}_female_neo.txt" \
                    --output_tsv_file "../output/mlm_output/bias_R2_factor${factor_num}_${selection_criteria}_female_neo.tsv"   
        done
    done
}
